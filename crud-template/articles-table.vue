<template>
  <div class="container {{resourceName}}-table">
    ...
    <main>
      <Table
        border
        :data="{{resourceName}}State.data"
        :columns="columns"
        :loading="{{resourceName}}State.loading"
        :max-height="540"
      ...
      <Row type="flex" justify="end" style="margin-top:15px">
        <Col>
          <Page
            :current="{{resourceName}}State.page"
            :total="{{resourceName}}State.total"
            :page-size="{{resourceName}}State.pageSize"
            show-sizer
            show-total
...
import {{resourceName}}Store from './store';
export default {
    ...
    data() {
        return {
            {{resourceName}}State: {{resourceName}}Store.state,
            columns: [
                {
                    type: 'expand',
                    width: 50,
